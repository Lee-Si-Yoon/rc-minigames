...
import type { FadingProp } from '../../../views/fading-text/fading';
import Fading from '../../../views/fading-text/fading';
import MobilePicker from '../../../views/mobile-picker/mobile-picker';
import type { RadialGradientProp } from '../../../views/radial-gradient/radial-gradient';
import RadialGradient from '../../../views/radial-gradient/radial-gradient';
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <input
              ...
              onChange={(e) => {
                return setTextValues(e.target.value.replace(' ', ','));
              }}
              type="text"
              name="texts"
              id="texts"
